...
*Laundry, accounted for.* A local-first PWA for people who hand laundry to a shop weekly and keep manual records. Single-user, on-device, free, open source (MIT).
