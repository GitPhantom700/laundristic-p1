...
- **P4.3 [AG]** Confluence mirror: one-way publish `/docs` → Confluence space "Tally" (script or manual; repo stays source of truth). ✓ Space matches repo docs.
- **P4.4 [CHAT]** Launch review: README/portfolio polish, LinkedIn framing. ✓ Done in planning chat.
